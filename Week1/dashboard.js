...
// let table="<thead><tr><th>Devices</th><th>MAC Address</th><th>IP</th><th> Created Date</th><th>Power Consumpiton (Kw/H)</th></tr></thead><tbody>";
// var a=0;
// for (let i = 1; i <x.length+1; i++) {
//     a=a+x[i-1].powerConsumption;
//     table += "<tr><td>" +
//         x[i-1].devices +
//         "</td><td>" +
//         x[i-1].mac_address+
...
//         x[i-1].createdDate+
//         "</td><td>" +
//         x[i-1].powerConsumption+
//         "</td></tr>";
// };
// table = table+"<tr><td>"+"Total"+"</td><td><td></td><td></td><td>"+a+"</td></tr></tbody>"
...
function reload(dataset){
    table="<thead><tr><th>Devices</th><th>MAC Address</th><th>IP</th><th> Created Date</th><th>Power Consumpiton (Kw/H)</th></tr></thead><tbody>";
    a=0;
